...
class InstrumentDataset(Dataset):
    ...
    """
    def __init__(self, data_dir, augment=False, max_samples_per_class=1000): #Augment: aumento dedatos, max límite de audios por clase
        """
...
class InstrumentCNN(nn.Module): #Hereda de nn.Module
    ...
    def __init__(self, num_classes):
        ...
        self.classifier = nn.Sequential( 
            nn.Linear(256, 256), #Proyecta 128 características a 256 neuronas
            nn.ReLU(),
