...
class AudioProcessor:
    """Clase para procesamiento de audio usando STFT (Short-Time Fourier Transform).
    
    Implementa:
    - Remuestreo a 22.05 kHz
    - Conversión a mono
    - Padding/trimming a 3 segundos
    - Transformada STFT con n_fft=2048
    - Normalización en escala logarítmica (dB)
    """
    def __init__(self, sample_rate=22050, n_fft=2048):
        self.sample_rate = sample_rate 
        self.n_fft = n_fft 
        #Transformar ondas a un espectograma
        self.stft_transform = torchaudio.transforms.Spectrogram( #Transformación para convertir auido en espectrogramas convencionales
...
class TrainingVisualizer:
    ...
    def _plot_metrics(self):
        ...
        plt.tight_layout()
        plt.savefig('training_metricsespectrocon.png')
        plt.close()
    ...
    def _plot_confusion_matrix(self, model, loader):
        ...
        plt.tight_layout()
        plt.savefig('confusion_matrixespectrocom.png')
        plt.close()
